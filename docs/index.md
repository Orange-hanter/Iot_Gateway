...
- **v0 (Python, demo)** — завершён 2026-04-20, заморожен. Архив: ветка `legacy/python-demo`, тег `v0.1-demo`.
- **v2 (Go, greenfield)** — текущая ветка `main`. Эта документация описывает целевое состояние v2; связь с кодом v0 не поддерживается.
