...
- **button_dht11/** - Прошивка для кнопки + влажности DHT11 (+ обертка температуры)
- **bridge_button_dht11.py** - Мост для Button+DHT11 устройства
...
- Button+DHT11: [docs/ARDUINO_BUTTON_DHT11.md](../docs/ARDUINO_BUTTON_DHT11.md)

## Поддерживаемые датчики

- ✅ **MQ2** - Газы (LPG, пропан, метан, водород, дым)
- ✅ **Button + DHT11** - Кнопка, влажность и обертка для температуры
